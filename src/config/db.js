...
//     console.log("Connected to Database Locals11111111 " + DB_NAME);
// });
// connection1.on("error", (err) => {
//     console.log("Error connecting to Database Locals1111111111111: " + err);
// });
...
//         console.log(connection1.readyState)
//     }

//     connection1.on("disconnected", () => {
//         console.log("Disconnected from Database Locals");
//     });
...
const setDbName = async (dbName) => {
    DB_NAME = dbName;
    console.log('DB_NAME', DB_NAME)
    const conecction = await connectToLocalDb(DB_NAME);
    return conecction;
}
...
// Iniciar la conexión con la base de datos por defecto.
// connectToLocalDb(DB_NAME);
