...
module.exports = {
    ...
    NAME_TEMPLATE_STEP_TWO_INMEDIATO: "ingresar_direccion",

    // CREDENCIALES DE META
    TOKEN_PARA_META: "793550265525818",
    META_PHONE_ID: "108695265534016",
    TOKEN_PERMANENTE: "EAALRutGwJjoBAADcsZAQjf4FtY4rNDIX2TBngZAaOZC4nhNjkeZAxS6TgVC4KKmrAqklLe9gnJFscjTKEGc0IXu6zkZCPZArix1CZC7KRlRVSL5emJ5M9NwEpuQr5szpC7TmtH7RKDmUCHtOF2QGze8UXJU1yfxIGfxJEXItefY99U5zwhZCJqBzr8GkVpQTKClJclWSXCQbuawTjUZBhX5rJzsAsPPeY97U4IbIoAXZCoYgZDZD",

    // TIPO DE MENSAJE QUE LLEGA
    TYPE_MESSAGE_META_RECIVE_TEXT: 'text',
    TYPE_MESSAGE_META_RECIVE_BUTTON: 'button',
    // TIPO DE MENSAJE A ENVIAR 
    TYPE_MESSAGE_META_SEND_TEMPLATE: 'template',
    TYPE_MESSAGE_META_SEND_TEXT: 'text',
    TYPE_MESSAGE_META_SEND_INTERACTIVE: 'interactive',

    // OPCIONES MARCADAS 
    DELIVERY_MODALIDAD_INMEDIATA_TXT_META: "Entrega inmediata",
    DELIVERY_MODALIDAD_PORRECOGER_TXT_META: "Recojo en tienda",
    DELIVERY_MODALIDAD_PROGRAMADO_TXT_META: "Entrega programada",
    CHOOSE_PRODUCTS_TXT_META: 'Escoger productos',
    DELIVERY_UPDATE_ORDER_TXT_META: 'Actualizar productos',
    DELIVERY_CONFIRM_ORDER_TXT_META: 'Confirmar orden',
